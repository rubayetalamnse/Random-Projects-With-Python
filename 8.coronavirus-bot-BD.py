...
def covid_update():
    ...
    data = response.json()
    confirmed_cases = data[30]['cases']  # 30 is the row number of Bangladesh.
    deaths = data[30]['deaths']
    today_cases = data[30]['todayCases']
    today_deaths = data[30]['todayDeaths']
    recovered = data[30]['recovered']
